...
func DarkTheme() fyne.Theme {
	theme := &builtinTheme{
		...
		background:     color.RGBA{0x32, 0x32, 0x32, 0xff},
		...
		//primary:        color.RGBA{0x1a, 0x23, 0x7e, 0xff}, // original blue
		//primary: color.RGBA{0xbb, 0x86, 0xfc, 0x8f}, // material magenta
		//primary: color.RGBA{0x37, 0x00, 0xb3, 0xff}, // material blue
		//primary: color.RGBA{0x62, 0x00, 0xee, 0xff}, // material blue
		primary: color.RGBA{37, 66, 89, 1},
		// primary: color.RGBA{0x9F, 0xA8, 0xDA, 0xff}, // material lt blue
		// primary:   color.RGBA{0x80, 0xCB, 0xC4, 0xff}, // material teal
